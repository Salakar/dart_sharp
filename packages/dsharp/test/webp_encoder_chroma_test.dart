...
void main() {
  ...
  test('WebP lossy encoder preserves third horizontal second vertical chroma '
      'detail', () async {
    final bytes = <int>[
      for (var row = 0; row < 8; row += 1)
        for (var col = 0; col < 8; col += 1)
  ...
  test('WebP lossy encoder preserves second horizontal third vertical chroma '
      'detail', () async {
    final bytes = <int>[
      for (var row = 0; row < 8; row += 1)
        for (var col = 0; col < 8; col += 1)
          if ((((col >> 1) == 0) || ((col >> 1) == 3)) ==
              (row >> 1).isEven) ...<int>[255, 0, 0, 255] else ...<int>[
            0,
            0,
            255,
            255,
  ...
  test('WebP lossy encoder preserves third horizontal third vertical chroma '
      'detail', () async {
    final bytes = <int>[
      for (var row = 0; row < 8; row += 1)
        for (var col = 0; col < 8; col += 1)
          if ((col >> 1).isEven == (row >> 1).isEven) ...<int>[
            255,
            0,
            0,
            255,
