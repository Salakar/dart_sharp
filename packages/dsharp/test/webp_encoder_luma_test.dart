...
void main() {
  ...
  test(
    'WebP lossy encoder preserves second horizontal third vertical luma detail',
    () async {
      final bytes = <int>[
        for (var row = 0; row < 4; row += 1)
          for (var col = 0; col < 4; col += 1)
            if ((col == 0 || col == 3) == row.isEven) ...<int>[
              255,
              255,
              255,
              255,
  ...
  test(
    'WebP lossy encoder preserves third horizontal third vertical luma detail',
    () async {
      final bytes = <int>[
        for (var row = 0; row < 4; row += 1)
          for (var col = 0; col < 4; col += 1)
            if (col.isEven == row.isEven) ...<int>[
              255,
              255,
              255,
              255,
