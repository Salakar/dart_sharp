...
/// Builds an invalid animation frame with duplicate VP8L image chunks.
Uint8List animatedVp8lWebpWithDuplicateImageChunk() {
  final frame = _vp8lPayload(
    width: 1,
    height: 1,
    red: 12,
...
/// Builds an invalid animation frame with trailing partial chunk bytes.
Uint8List animatedVp8lWebpWithTrailingFrameBytes() {
  final frame = _vp8lPayload(
    width: 1,
    height: 1,
    red: 12,
