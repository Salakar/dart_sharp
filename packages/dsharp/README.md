...
- Codecs: raw plus first-party PNG, JPEG, GIF, TIFF, and WebP support without
  runtime package dependencies. PNG, baseline/progressive/lossless JPEG, GIF,
  TIFF, WebP VP8L lossless static/animated, and raw output are implemented.
...
- Output: typed encoder options, `toBytes`, `toBytesWithInfo`,
  ...
  per-frame delay controls, explicit/kept JPEG/PNG/WebP XMP metadata writes,
