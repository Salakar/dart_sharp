...
final class DsharpCapabilities {
  ...
  static const DsharpCapabilities
  current = DsharpCapabilities._(<ImageFormat, CodecSupport>{
    ...
    ImageFormat.webp: CodecSupport(
      ...
      reason:
          'WebP container metadata is parsed; pixel reconstruction is not complete yet.',
    ),
